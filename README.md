...
| 버전 코드      | 버전                                                                                         | 주요 기능                  |
|------------|--------------------------------------------------------------------------------------------|------------------------|
| Antidote   | [1.10.1-1.21.1](https://github.com/LUDDANG/EventTransactionLib/releases/tag/1.10.0-1.21.1) | 클래스로더 호환 오류 수정         |
| Antidote   | [1.10.1-1.20.4](https://github.com/LUDDANG/EventTransactionLib/releases/tag/1.10.1-1.20.4) | 클래스로더 호환 오류 수정         |
